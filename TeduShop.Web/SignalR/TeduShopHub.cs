...
namespace TeduShop.Web.SignalR
{
    ...
    public class TeduShopHub : Hub
    {
        ...
        public static void PushToAllUsers(OrderViewModel message, TeduShopHub hub)
        {
        ...
        public static void PushToUser(string who, OrderViewModel message, TeduShopHub hub)
        {
            IHubConnectionContext<dynamic> clients = GetClients(hub);
        ...
        /// <param name="who"></param>
        /// <param name="message"></param>
        public static void PushToUsers(string[] whos, OrderViewModel message, TeduShopHub hub)
        {
            IHubConnectionContext<dynamic> clients = GetClients(hub);
